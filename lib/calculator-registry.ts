...
export const CALCULATORS_REGISTRY: Record<string, CalculatorItem> = {
  ...
  "mangal-dosha": {
    ...
    iconName: "Flame",
    shortDescription: "Check your Manglik status across Lagna, Moon, and Venus charts along with classical cancellation rules and remedies.",
    seoTitle: "Mangal Dosha Calculator — Check Your Manglik Status Free | AstroRomantic",
    metaDescription: "Enter your birth date, time, and place to see whether Mars falls in a Mangal Dosha house across Lagna, Moon, and Venus charts — and check classical cancellation rules.",
    h1: "Mangal Dosha Calculator — Check Your Manglik Status Free",
    directAnswer: "Mangal Dosha (also called Manglik Dosha, Kuja Dosha, or Chevvai Dosham) occurs when Mars sits in the 1st, 2nd, 4th, 7th, 8th, or 12th house of your birth chart. In Hindu marriage matching, it's one of the most-checked placements because three of those six houses — the 2nd, 7th, and 8th — govern family, marriage, and shared life directly. This calculator checks Mars against your Lagna (Ascendant), Moon, and Venus charts, then applies classical cancellation rules before giving you a final verdict — not just a raw 'yes/no.'",
    howItWorks: [
      { step: "1", title: "Enter Exact Birth Details", text: "Enter exact birth date, time, and place. An inaccurate birth time can shift Mars into a neighboring house and change the result entirely — precision matters here more than almost anywhere else in astrology." },
      { step: "2", title: "Build Three Charts", text: "The calculator builds three charts: the Lagna chart (Ascendant-based), the Moon chart (Chandra Lagna), and the Venus chart (Shukra Lagna)." },
      { step: "3", title: "Check 6 Dosha Houses", text: "Mars' house position is checked against the six dosha houses: 1, 2, 4, 7, 8, and 12 across all three charts." },
      { step: "4", title: "Apply Cancellation Rules", text: "Classical cancellation rules (Mangal Dosha Nivaran) are applied to determine whether the placement is active, neutralized, or reduced." }
    ],
    faqs: [
      { question: "What is Mangal Dosha in simple terms?", answer: "Mangal Dosha is a placement in Vedic astrology where Mars sits in one of six specific houses (1, 2, 4, 7, 8, or 12) of a birth chart — traditionally believed to influence temperament, family relations, and marital harmony. A person with this placement is called Manglik." },
      { question: "Does Mangal Dosha end at age 28?", answer: "Not technically — the placement of Mars in your chart is permanent and doesn't change with age. However, many astrologers hold that the dosha's practical, lived intensity softens with emotional maturity." },
      { question: "Can two Mangliks marry each other?", answer: "Yes — this is one of the most classically accepted cancellation rules in Vedic astrology. When both partners carry Mangal Dosha, the two placements are traditionally considered to cancel each other out for that specific match." },
      { question: "Is Mangal Dosha the same as Kuja Dosha or Chevvai Dosham?", answer: "Yes — these are regional names for the same underlying placement. Kuja Dosha is common in South Indian astrology, Bhauma Dosha appears in classical Sanskrit texts, and Chevvai Dosham (or Chovva Dosham) is used in Tamil astrological tradition." },
      { question: "If I have Mangal Dosha, does it mean my marriage is doomed?", answer: "No — this is a common misconception. Mangal Dosha is one factor among many in a full compatibility reading, and classical cancellation rules (own-sign or exalted Mars, benefic aspects, both partners being Manglik) frequently neutralize or significantly reduce its effect." }
    ],
    educationalTitle: "About Mangal Dosha",
    educationalBody: [
      "Mangal Dosha is one of the oldest and most consulted placements in Vedic marriage astrology. Mars — Mangal — is the planet of drive, aggression, courage, and heat. In most houses of a chart, that heat is an asset: ambition, protection, competitive edge. But when Mars lands in one of six particular houses — 1, 2, 4, 7, 8, or 12 — tradition holds that its intensity presses directly on self, family/speech, home, marriage, shared resources/longevity, or isolation. A person carrying this placement is called a Manglik.",
      "The dosha is regional in name but consistent in principle across Indian traditions — Kuja Dosha in the South, Bhauma Dosha in classical texts, and Chevvai Dosham (or Chovva Dosham) in Tamil practice. Both men and women can be Manglik, and the placement is checked the same way for both.",
      "Mangal Dosha Houses & What They Mean:\n• 1st House (Lagna): Self, personality, physical vitality (Moderate intensity — affects temperament in marriage)\n• 2nd House: Family, speech, wealth (Moderate intensity — can create friction in family relations)\n• 4th House: Home, emotional foundation, mother (Moderate intensity — can unsettle domestic peace)\n• 7th House: Marriage, partnership, spouse (Strongest intensity — most classically significant placement)\n• 8th House: Longevity, shared resources, transformation (Strong intensity — associated with sudden change or obstacles)\n• 12th House: Loss, isolation, foreign travel (Moderate intensity — can create emotional distance in marriage)",
      "Common Cancellation Rules (Mangal Dosha Nivaran):\n• Mars in its own sign (Aries or Scorpio) or exalted (Capricorn) in a dosha house — neutralized since Mars is comfortable.\n• Mars aspected or conjunct Jupiter, a natural benefic, softens the dosha considerably.\n• Both partners are Manglik — when both partners carry Mangal Dosha, tradition holds that the two placements cancel each other out for that specific match.\n• Age-based softening — while the chart placement is permanent, its practical intensity lessens as emotional maturity develops past Mars-ruled life stages.",
      "Traditional Remedies (Practices of Pacification):\n• Mangal Shanti Puja (often performed at Mangalnath Temple in Ujjain).\n• Tuesday Fasting (Mangalvaar).\n• Hanuman Chalisa recitation and Mangal Mantra japa.\n• Kumbh Vivah (symbolic ceremony before marriage to absorb initial intensity).\n• Red Coral (Moonga) gemstone (worn only with proper astrological guidance).",
      "Does Mangal Dosha Really Threaten a Marriage?\nThis is worth addressing directly: classical texts treat Mangal Dosha seriously, but a single placement was never meant to be read in isolation. A qualified astrologer weighs Mangal Dosha alongside the full birth chart: overall planetary strength, other yogas present, and Gun Milan compatibility. Two Mangliks marrying each other is considered a complete non-issue. Mangal Dosha is a factor to understand and account for, not an automatic verdict against a marriage."
    ],
    relatedCalculators: [
      { name: "Kundli Matching", href: "/calculators/kundli-matching/" },
      { name: "Sade Sati Calculator", href: "/calculators/sade-sati/" },
  ...
  "chaldean-numerology-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Decodes the mestic sound-vibration frequencies of your name using ancient Chaldean numerology.",
    seoTitle: "Chaldean Numerology Calculator | AstroRomantic",
    metaDescription: "Calculate Chaldean sound-vibration numbers for your name without number 9.",
    h1: "Chaldean Numerology Calculator",
    directAnswer: "Chaldean Numerology maps letters to numbers 1-8 based on ancient sacred sound frequencies, omitting number 9.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Ancient Chaldean Sound Vibrations",
    educationalBody: ["Chaldean numerology maps letters to numbers 1-8 based on sound frequencies."],
    relatedCalculators: [],
    customHref: "/numerology/chaldean-numerology-calculator/"
  },
  "life-path-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Calculate your core life path number, destiny, and personality traits using Pythagorean numerology.",
    seoTitle: "Life Path Number Calculator | AstroRomantic",
    metaDescription: "Discover your life path number from your full birth date.",
    h1: "Life Path Number Calculator",
    directAnswer: "Your life path number reveals your core identity and spiritual purpose.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Understanding Your Life Path",
    educationalBody: ["Your life path number is derived from your birth date."],
    relatedCalculators: [],
    customHref: "/numerology/life-path-calculator/"
  },
  "name-numerology-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Analyze your full birth name to reveal Destiny, Soul Urge, and Expression numbers.",
    seoTitle: "Name Numerology Calculator | AstroRomantic",
    metaDescription: "Analyze full birth name letter frequencies.",
    h1: "Name Numerology Calculator",
    directAnswer: "Name numerology maps letters A-Z to numbers 1-9.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Name Frequencies",
    educationalBody: ["Your name carries acoustic energy."],
    relatedCalculators: [],
    customHref: "/numerology/name-numerology-calculator/"
  },
  "destiny-number-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Discover your cosmic purpose and lifetime goals written in your full birth name.",
    seoTitle: "Destiny Number Calculator | AstroRomantic",
    metaDescription: "Calculate your destiny number.",
    h1: "Destiny Number Calculator",
    directAnswer: "Your destiny number describes your lifelong mission.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Destiny Alignment",
    educationalBody: ["Your destiny number is calculated from all letters in your name."],
    relatedCalculators: [],
    customHref: "/numerology/destiny-number-calculator/"
  },
  "soul-urge-number-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Uncover your innermost desires and emotional motivations calculated from name vowels.",
    seoTitle: "Soul Urge Number Calculator | AstroRomantic",
    metaDescription: "Calculate your heart's desire number from vowels.",
    h1: "Soul Urge Number Calculator",
    directAnswer: "Soul Urge reveals what your heart truly desires.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Heart's Desire",
    educationalBody: ["Vowels carry the internal spiritual vibration."],
    relatedCalculators: [],
    customHref: "/numerology/soul-urge-number-calculator/"
  },
  "baby-name-numerology-calculator": {
    slug: "baby-name-numerology-calculator",
    name: "Baby Name Numerology Calculator",
    category: "Numerology",
    categorySlug: "numerology",
    iconName: "Hash",
    shortDescription: "Evaluate the numerological frequency of proposed baby names for high-vibration harmony.",
    seoTitle: "Baby Name Numerology Calculator | AstroRomantic",
    metaDescription: "Analyze baby name numerology.",
    h1: "Baby Name Numerology Calculator",
    directAnswer: "Choose high-vibration names for your newborn.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Baby Name Frequencies",
    educationalBody: ["A baby's name shapes their outer social expression."],
    relatedCalculators: [],
    customHref: "/numerology/baby-name-numerology-calculator/"
  },
  "marriage-numerology-calculator": {
    slug: "marriage-numerology-calculator",
    name: "Marriage Numerology Calculator",
    category: "Numerology",
    categorySlug: "numerology",
    iconName: "Heart",
    shortDescription: "Determine the most harmonious wedding dates based on couple birth date alignment.",
    seoTitle: "Marriage Numerology Calculator | AstroRomantic",
    metaDescription: "Find harmonious wedding dates.",
    h1: "Marriage Numerology Calculator",
    directAnswer: "Align your wedding date with couple birth frequencies.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Wedding Date Alignment",
    educationalBody: ["Marriage dates carry numerological vibrations."],
    relatedCalculators: [],
    customHref: "/numerology/marriage-numerology-calculator/"
  },
  "lucky-number-calculator": {
    ...
    categorySlug: "numerology",
    iconName: "Sparkles",
    shortDescription: "Identify daily lucky numbers based on your birth date and name numerology.",
    seoTitle: "Lucky Number Calculator | AstroRomantic",
    metaDescription: "Calculate daily lucky numbers.",
    h1: "Lucky Number Calculator",
    directAnswer: "Find your personal fortune numbers.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Personal Luck Frequencies",
    educationalBody: ["Lucky numbers harmonize with your daily Life Path."],
    relatedCalculators: [],
    customHref: "/numerology/lucky-number-calculator/"
  },
  "love-percentage-calculator": {
    ...
    categorySlug: "compatibility",
    iconName: "Heart",
    shortDescription: "Calculate romantic attraction and phonetic name affinity percentages for couples.",
    seoTitle: "Love Percentage Calculator | AstroRomantic",
    metaDescription: "Calculate exact romantic attraction percentage.",
    h1: "Love Percentage Calculator",
    directAnswer: "Measure romantic affinity between two names.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Name Attraction Science",
    educationalBody: ["Name acoustics measure romantic compatibility."],
    relatedCalculators: [],
    customHref: "/love/love-percentage-calculator/"
  },
  "zodiac-love-calculator": {
    ...
    categorySlug: "compatibility",
    iconName: "Star",
    shortDescription: "Evaluate sun sign elemental compatibility and astrological chemistry between partners.",
    seoTitle: "Zodiac Love Compatibility Calculator | AstroRomantic",
    metaDescription: "Test sun sign elemental compatibility.",
    h1: "Zodiac Love Compatibility",
    directAnswer: "Compare fire, earth, air, and water elements between signs.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Zodiac Elemental Chemistry",
    educationalBody: ["Sun sign elements determine natural ease or friction."],
    relatedCalculators: [],
    customHref: "/love/zodiac-love-calculator/"
  },
  "relationship-compatibility-calculator": {
    slug: "relationship-compatibility-calculator",
    name: "Relationship Compatibility Calculator",
    category: "Compatibility",
    categorySlug: "compatibility",
    iconName: "Heart",
    shortDescription: "Analyze multi-pillar relationship harmony including emotional, mental, and lifestyle alignment.",
    seoTitle: "Relationship Compatibility Calculator | AstroRomantic",
    metaDescription: "Analyze relationship chemistry.",
    h1: "Relationship Compatibility Calculator",
    directAnswer: "Evaluate key relationship pillars for long-term harmony.",
    howItWorks: [],
    faqs: [],
  ...
  "marriage-compatibility-calculator": {
    ...
    categorySlug: "compatibility",
    iconName: "Heart",
    shortDescription: "Check lifelong marital alignment, financial goals, and family value compatibility.",
    seoTitle: "Marriage Compatibility Calculator | AstroRomantic",
    metaDescription: "Test lifelong marital alignment.",
    h1: "Marriage Compatibility Calculator",
    directAnswer: "Check long-term commitment and family harmony.",
    howItWorks: [],
    faqs: [],
  ...
  "soulmate-calculator": {
    ...
    categorySlug: "compatibility",
    iconName: "Sparkles",
    shortDescription: "Measure spiritual connection and destiny alignment to see if you share a soulmate bond.",
    seoTitle: "Soulmate Calculator | AstroRomantic",
    metaDescription: "Measure spiritual soulmate connection.",
    h1: "Soulmate Calculator",
    directAnswer: "Discover spiritual soulmate alignment.",
    howItWorks: [],
    faqs: [],
  ...
  "couple-name-combiner": {
    ...
    metaDescription: "Combine two names into one cute couple name.",
    h1: "Couple Name Combiner",
    directAnswer: "Generate blended names for couples.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Couple Naming",
    educationalBody: ["Blend syllables from both names."],
    relatedCalculators: [],
    customHref: "/couple-names/couple-name-combiner/"
  },
  "ship-name-generator": {
    ...
    metaDescription: "Create fun ship names.",
    h1: "Ship Name Generator",
    directAnswer: "Get custom ship names for social media.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Social Ship Names",
    educationalBody: ["Ship names combine partner names."],
    relatedCalculators: [],
    customHref: "/couple-names/ship-name-generator/"
  },
  "nickname-generator": {
    ...
    metaDescription: "Generate affectionate nicknames.",
    h1: "Cute Nickname Generator",
    directAnswer: "Find sweet pet names for your partner.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Romantic Nicknames",
    educationalBody: ["Pet names foster intimacy."],
    relatedCalculators: [],
    customHref: "/couple-names/nickname-generator/"
  },
  "couple-hashtag-generator": {
    ...
    metaDescription: "Generate wedding and couple hashtags.",
    h1: "Couple Hashtag Generator",
    directAnswer: "Create custom hashtags for couple photos.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Social Media Hashtags",
    educationalBody: ["Hashtags organize your memories."],
    relatedCalculators: [],
    customHref: "/couple-names/couple-hashtag-generator/"
  },
  "couple-username-generator": {
    ...
    metaDescription: "Generate shared usernames.",
    h1: "Couple Username Generator",
    directAnswer: "Create shared handles for social accounts.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Shared Social Handles",
    educationalBody: ["Joint usernames reflect unity."],
    relatedCalculators: [],
  ...
  "wedding-vow-generator": {
    ...
    metaDescription: "Create custom wedding vows.",
    h1: "AI Wedding Vow Generator",
    directAnswer: "Draft personalized romantic vows for your ceremony.",
    howItWorks: [],
    faqs: [],
  ...
  "love-letter-generator": {
    ...
    metaDescription: "Write poetic love letters with AI.",
    h1: "AI Love Letter Generator",
    directAnswer: "Generate heartfelt love letters instantly.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "The Art of Love Letters",
    educationalBody: ["Express deep emotions through romantic prose."],
    relatedCalculators: [],
    customHref: "/ai-generators/love-letter-generator/"
  },
  "romantic-message-generator": {
    ...
    metaDescription: "Generate daily romantic messages.",
    h1: "AI Romantic Message Generator",
    directAnswer: "Create daily romantic texts for your partner.",
    howItWorks: [],
    faqs: [],
    educationalTitle: "Daily Expression of Love",
